...
Где могут находиться дефекты?
    ...
    Дефекты могут находиться в различных частях программного продукта. Вот несколько мест, где часто происходит обнаружение дефектов:
